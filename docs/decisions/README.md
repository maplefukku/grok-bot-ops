...
日次の採否は [`trend-log.md`](./trend-log.md) に残す。Planner の台帳である。判断行の Python 契約は [`scripts/trend_adopt_contract.py`](../../scripts/trend_adopt_contract.py) である。
...
| 0004 | [チャット秘密・Webhook提案のみ・Astra WRAP・thrift](./0004-chat-secrets-webhook-astra-thrift.md) | Accepted |
