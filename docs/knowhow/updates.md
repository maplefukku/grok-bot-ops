...
Grok Bot のプロダクトアップデートの時系列ログ。新しいものを上に足す。出典は公式に辿れる http(s) リンクだけ。無い行は書かない。
...
| 2026-09-17 | Grok Bot 0.56.1。コネクタ接続中（connection still in progress）を表示できるようになった（SpaceXAI notes via blankspeaker。未完了の可能性あり） | [x.com/blankspeaker/status/2100668524943601732](https://x.com/blankspeaker/status/2100668524943601732) | 未 |
| 2026-09-17 | Grok Bot Galaxy 最終日: 既存ユーザーへ usage reset、ライブチャット参加の新規ユーザーへ 1 ヶ月無料（$200 相当）。メール告知の二次ソース | [x.com/blankspeaker/status/2100684433074634953](https://x.com/blankspeaker/status/2100684433074634953) | 未 |
| 2026-09-16 | Team Bots（WIP）: チームメイトが共有したエージェントを Team bots から追加し sidebar に置く。Team / Enterprise 向けに開発中（SpaceXAI notes via blankspeaker） | [x.com/blankspeaker/status/2100240045961838833](https://x.com/blankspeaker/status/2100240045961838833) | 未 |
| 2026-09-15 | Grok Bot 0.52.0。sidebar でエージェントをピン留めできる（SpaceXAI notes via blankspeaker。未完了の可能性あり） | [x.com/blankspeaker/status/2099945194779263154](https://x.com/blankspeaker/status/2099945194779263154) | 未 |
...
書式: 時期は判明している最も細かい粒度で（日付が分かるなら `2026-08-26`）。公式出典が取れない項目は書かない。
