...
`job-brief` と `cloud` と `pr` は [`docs/process/pr-body.md`](../docs/process/pr-body.md) を指し、box テンプレと humanlayer show-me を WRAP する。ここにチェックリストを足さない。harness は invent しない。
