...
| [`X伸び分析`](./X伸び分析.md) | x.growth-analyzer。EVERY @sora19ai LIVE postで+1h/+3h/+6h/+12h/+18h/+24hのviews/likes/replies/RTsを計測。fxtwitter GET WRAP（X MCPあれば優先）。thin JSON ledgerで伸び型を学びOUTはBuddy+CMO。cascade-parent=CMO&#124;X運用。独立ジョブは並列。3美徳（ボットにやらせる / 会議せずPRかフラグ / 結果はオーナー） | いいえ |
