...
| 名前 | 役割 | 回すまで動かない |
|---|---|---|
| [`最後の一針企画`](./最後の一針企画.md) | laststitch.docs。docs/laststitch/ だけ書く。SPEC は https://github.com/maplefukku/grok-bot-ops/issues/8 。IGログインも投稿もパスワードもマージもしない。独立ジョブは並列。3美徳（ボットにやらせる / 会議せずPRかフラグ / 結果はオーナー） | はい |
